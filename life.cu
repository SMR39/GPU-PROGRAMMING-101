...
int main(int argc, char ** argv)
{
    ...
    dim3  threads(threads_per_block/2, threads_per_block/2);	// CUDA block dimensions
	//dim3  threads(threads_per_block/8, threads_per_block/8);	// CUDA block dimensions for 1 thread computing 16 cells
    ...
    int shared_mem_size= 8 *8 * sizeof(int);
